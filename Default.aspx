...
<body>
  ...
  <header id="header" class="header-tops">
    ...
    <div class="container">
      ...
      <h1><a href="Default.aspx">İsmail ÇOBAN</a></h1>
      <h2 style="color:#fff">I'm <span class="typing" style="color:#12D640"></span></h2>
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          <li class="active"><a href="#header"> <span>Anasayfa</span></a></li>
          <li><a href="#about"><span>Hakkında</span></a></li>
          <li><a href="#education"> <span>Eğitim</span></a></li>
          <li><a href="#experience"> <span>Tecrübe</span></a></li>
<!--          <li><a href="#projects"> <span>Projects</span></a></li>-->
          <li><a href="#portfolio"> <span>Projeler</span></a></li>
          <li><a href="#skills"> <span>Yetenekler</span></a></li>
          <li><a href="https://drive.google.com/file/d/1pT-Nk6AxY9ZOWBizuDb4htA3IiUF_fSe/view?usp=sharing" target="_blank"> <span>CV</span></a></li>
          <!-- <li><a href="#links"> <span>Resume & Links</span></a></li> -->
          <li><a href="#contacts"> <span>İletişim</span></a></li>
      ...
      <div class="social-links">
          ...
          <a href="mailto:ismailcoban365@gmail.com" target="_blank" class="google"><i class="bx bxl-google"></i></a>
    ...
    <div class="about-me container">
      ...
      <div class="row">
        <div class="col-lg-4" data-aos="fade-right">
          <img src="assets/img/elma.jpg" class="img-fluid" alt="">
        </div>
